export const Footer = () => {
  return (
    <footer className="footer">
      <aside className="d-flex gap-2 py-2">
        <svg
          width="50"
          height="50"
          viewBox="0 0 24 24"
        ...
        >
          <path fill="#fff" d="M12 2c-3.5 5.5-7 8-7 12 0 3.866 3.134 7 7 7s7-3.134 7-7c0-4-3.5-6.5-7-12zm0 17c-2.209 0-4-1.791-4-4 0-1.389.707-2.651 1.793-3.454.648.857 1.813 1.454 3.207 1.454 1.564 0 2.743-1.245 2.993-2.654.642 1.029 1.007 2.264 1.007 3.654 0 2.209-1.791 4-4 4z" />
        </svg>
        <p className="font-bold">
          DevTinder!
          Connecting Developers and Collaborate 
        </p>
        <p><strong>Copyright © {new Date().getFullYear()}</strong> - All right reserved</p>
      </aside>
      <nav className="d-flex justify-content-center align-item-center gap-5 py-2">
          <a
          ...
          >
            <svg
              ...
              className="fill-current"
            >
              <path fill="#fff" d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.761 0 5-2.239 5-5v-14c0-2.761-2.239-5-5-5zm-11 19h-3v-10h3v10zm-1.5-11.268c-.966 0-1.75-.784-1.75-1.75s.784-1.75 1.75-1.75 1.75.784 1.75 1.75-.784 1.75-1.75 1.75zm13.5 11.268h-3v-5.604c0-1.336-.026-3.06-1.865-3.06-1.865 0-2.152 1.458-2.152 2.965v5.699h-3v-10h2.879v1.365h.042c.401-.759 1.379-1.56 2.839-1.56 3.038 0 3.597 2 3.597 4.604v5.591z" />
            </svg>
          </a>
          <a
